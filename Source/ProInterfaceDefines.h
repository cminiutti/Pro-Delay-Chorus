/*
  ==============================================================================
    ...
    ProInterfaceDefines.h
    Created: 4 Apr 2019 3:27:01pm
    Author:  minut
...
const Colour ProColour_1 = Colour(105, 105, 105);
const Colour ProColour_2 = Colour(0, 0, 0).withAlpha(0.0f);
const Colour ProColour_3 = Colour(0, 0, 0).withAlpha(0.3f);
const Colour ProColour_4 = Colour(0, 0, 0).withAlpha(0.6f);
const Colour ProColour_5 = Colour(105, 105, 105).withAlpha(0.3f);
const Colour ProColour_6 = Colour(0, 0, 0).withAlpha(0.8f);
const Colour ProColour_7 = Colour(125, 125, 125);
